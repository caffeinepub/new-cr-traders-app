...
function BrowserRouter({ children }) {
  ...
  const navigate = reactExports.useCallback((to, opts) => {
    if (opts == null ? void 0 : opts.replace) window.history.replaceState(null, "", to);
    else window.history.pushState(null, "", to);
    setPathname(window.location.pathname);
  }, []);
  const ctx = reactExports.useMemo(() => ({ pathname, navigate }), [pathname, navigate]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(RouterContext.Provider, { value: ctx, children });
}
...
const ParamsContext = reactExports.createContext({});
function Routes({ children }) {
  const { pathname } = reactExports.useContext(RouterContext);
  let matched = null;
  ...
  for (const child of items) {
    ...
    if (params !== null) {
      matched = /* @__PURE__ */ jsxRuntimeExports.jsx(ParamsContext.Provider, { value: params, children: element });
      break;
    }
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: matched });
}
...
function Navigate({
  ...
  const { navigate } = reactExports.useContext(RouterContext);
  reactExports.useEffect(() => {
    navigate(to, { replace });
  });
  return null;
...
function useParams() {
  return reactExports.useContext(ParamsContext);
}
...
function BottomNav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t border-gray-100 flex shadow-lg z-40", children: tabs.map((tab) => {
    const isActive = location2.pathname === tab.path;
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            tab.label === "Cart" && cartCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1.5 -right-1.5 bg-red-500 text-white text-xs w-3.5 h-3.5 rounded-full flex items-center justify-center", children: cartCount })
          ] }),
...
const RESPONSES = [
  ...
  [
    ...
    "Thank you for choosing NEW C.R. TRADERS! 🙏"
  ]
];
...
function ChatBot() {
  const idRef = reactExports.useRef(1);
  const [open, setOpen] = reactExports.useState(false);
  const [messages, setMessages] = reactExports.useState([
    {
      id: 0,
      role: "bot",
      text: "Namaste! 🙏 I'm your NEW C.R. TRADERS assistant. Ask me about products, pickup, or anything else!"
    }
  ]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-600 px-4 py-3 flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-sm", children: "AI Assistant" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-100 text-xs", children: "NEW C.R. TRADERS" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64 overflow-y-auto p-3 space-y-2", children: messages.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
...
function Home() {
  ...
  const searchResults = search.trim() ? PRODUCTS.filter(
    (p) => p.isAvailable && p.name.toLowerCase().includes(search.toLowerCase())
  ) : [];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-24 bg-gray-50 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-700 px-4 pt-10 pb-3 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-sm leading-tight", children: "NEW C.R. TRADERS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-200 text-xs", children: "Mahavir Ganj, Aligarh" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", "data-ocid": "home.notification_button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "text-white", size: 20 }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: "relative",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingCart, { className: "text-white", size: 22 }),
              cartCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1.5 -right-1.5 bg-orange-500 text-white text-xs rounded-full w-4 h-4 flex items-center justify-center", children: cartCount })
            ]
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pt-3 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center bg-white border border-gray-200 rounded-xl px-3 py-2 gap-2 shadow-sm", children: [
    ...
    search.trim() && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mb-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: searchResults.map((p) => {
        var _a2;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                ...
                ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-28 bg-gray-100 flex items-center justify-center text-3xl select-none", children: ((_a2 = CATEGORIES.find((c) => c.id === p.categoryId)) == null ? void 0 : _a2.emoji) ?? p.name.charAt(0) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-2 py-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs font-semibold leading-tight line-clamp-2", children: p.name }) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-800 line-clamp-2", children: p.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-700 font-bold text-xs mt-1", children: [
                  "₹",
                  p.price
                ] })
              ] })
      ...
      searchResults.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-sm text-gray-400 py-8", children: "No products found" })
    ] }),
    !search.trim() && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-2 rounded-2xl overflow-hidden relative h-40 shadow", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-base", children: "NEW C.R. TRADERS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-300 text-xs", children: "Mahavir Ganj, Aligarh – 202001" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-3 bg-amber-50 border border-amber-300 rounded-xl px-3 py-2.5 flex items-start gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg", children: "🏪" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-800 font-semibold text-xs", children: "Pickup Only" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-700 text-xs mt-0.5", children: "Customer ko order place karke shop par aana hoga — Mahavir Ganj, Aligarh" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800 text-sm mb-3", children: "All Categories" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mt-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800 text-sm mb-3", children: "Popular Products" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3", children: popularProducts.map((p) => {
          var _a2;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                  ...
                  ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-32 bg-gray-100 flex items-center justify-center text-4xl select-none", children: ((_a2 = CATEGORIES.find((c) => c.id === p.categoryId)) == null ? void 0 : _a2.emoji) ?? p.name.charAt(0) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: p.isPacked ? "Packed" : "Unpacked"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent px-2 py-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs font-semibold leading-tight line-clamp-2", children: p.name }) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-800 line-clamp-2 leading-tight", children: p.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-0.5", children: p.size }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-700 font-bold text-sm mt-1", children: [
                    "₹",
                    p.price
                  ] })
                ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-6 mb-4 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "GSTIN: 09BTFPK1482H1ZK | FSSAI: 22727411000024" }),
...
function AdminDashboard() {
  ...
  const [categories, setCategories] = reactExports.useState(
    () => JSON.parse(
      localStorage.getItem("ncrt_categories") || JSON.stringify(DEFAULT_CATEGORIES)
    )
  );
  ...
  const [editCategory, setEditCategory] = reactExports.useState(null);
  const [showAddProduct, setShowAddProduct] = reactExports.useState(false);
  ...
  const addProduct = () => {
    if (!newProd.name || !newProd.price || !newProd.categoryId) {
      ue.error("Name, price, and category required");
      return;
    }
    const p = {
      ...newProd,
      ...
      size: newProd.size || "",
      imageUrl: newProd.imageUrl || "https://images.unsplash.com/photo-1542838132-92c53300491e?w=300"
    };
  ...
  const updateOrderStatus = (id, status) => {
    const updated = orders.map((o2) => o2.id === id ? { ...o2, status } : o2);
    setOrders(updated);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gray-50", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-900 px-4 pt-10 pb-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-bold text-lg", children: "Admin Dashboard" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs", children: "NEW C.R. TRADERS" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3 px-4 mt-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b bg-white mx-4 mt-4 rounded-t-xl overflow-hidden", children: ["products", "categories", "orders"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-8", children: [
      tab === "products" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        showAddProduct && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-4 mb-4 shadow-sm space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm", children: "New Product" }),
          [
            "name",
            "size",
            "price",
            ...
            "input",
            {
              ...
              value: newProd[f] || "",
              onChange: (e) => setNewProd((p) => ({ ...p, [f]: e.target.value })),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: products.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: !p.isAvailable && "(Unavailable)" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { size: 14, className: "text-blue-600" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 14, className: "text-red-600" })
                }
              )
            ]
          },
      ...
      editProduct && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/50 z-50 flex items-end justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          "data-ocid": "admin.edit_product.dialog",
          className: "bg-white rounded-t-3xl w-full max-w-md p-6 max-h-[80vh] overflow-y-auto",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-base mb-4", children: "Edit Product" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "select",
                {
                  ...
                  onChange: (e) => setEditProduct(
                    (p) => p ? { ...p, categoryId: e.target.value } : p
                  ),
                  className: "w-full border border-gray-200 rounded-lg px-3 py-2 text-sm",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      ...
                      onChange: (e) => setEditProduct(
                        (p) => p ? { ...p, isPacked: e.target.checked } : p
                      )
                    }
                  ),
                  " ",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 text-sm", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "input",
                    {
                      ...
                      onChange: (e) => setEditProduct(
                        (p) => p ? { ...p, isAvailable: e.target.checked } : p
                      )
                    }
                  ),
                  " ",
      ...
      tab === "categories" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
        ...
        showAddCategory && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl p-4 mb-4 shadow-sm space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: categories.map((c, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
      ...
      editCategory && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black/50 z-50 flex items-end justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          "data-ocid": "admin.edit_category.dialog",
          className: "bg-white rounded-t-3xl w-full max-w-md p-6",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-base mb-4", children: "Edit Category" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  onClick: () => {
                    saveCategories(
                      categories.map(
                        (c) => c.id === editCategory.id ? editCategory : c
                      )
                    );
      ...
      tab === "orders" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 space-y-3", children: orders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
      ...
      ) : orders.map((order, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start mb-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm", children: order.customerName }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: order.customerPhone })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-700 font-bold text-sm", children: [
                "₹",
                order.totalAmount
              ] })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2", children: (() => {
              try {
                return JSON.parse(order.items).slice(0, 2).map(
...
function AdminLogin() {
  const navigate = useNavigate();
  const [loginType, setLoginType] = reactExports.useState("email");
  ...
  const handleLogin = (e) => {
    ...
    let valid = false;
    if (loginType === "email") {
      valid = ADMIN_EMAILS.includes(email.trim().toLowerCase()) && pin === ADMIN_PIN;
    } else {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 flex items-center justify-center px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm bg-white rounded-3xl p-8 shadow-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-gray-800", children: "Admin Login" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "NEW C.R. TRADERS" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex bg-gray-100 rounded-xl p-1 mb-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          className: `flex-1 py-2 text-xs font-semibold rounded-lg transition ${loginType === "email" ? "bg-white text-green-700 shadow-sm" : "text-gray-500"}`,
          children: "Email"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `flex-1 py-2 text-xs font-semibold rounded-lg transition ${loginType === "phone" ? "bg-white text-green-700 shadow-sm" : "text-gray-500"}`,
          children: "Phone"
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleLogin, className: "space-y-4", children: [
      loginType === "email" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "label",
          {
            htmlFor: "al-email",
...
function Cart() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-32 bg-gray-50 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-700 px-4 pt-10 pb-4 flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          onClick: () => navigate(-1),
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "text-white", size: 20 })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-bold text-lg", children: "My Cart" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-3 bg-amber-50 border border-amber-300 rounded-xl px-3 py-2.5 flex items-start gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-base", children: "🏪" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-800 font-semibold text-xs", children: "Pickup Only" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-700 text-xs mt-0.5", children: "Please come to our shop to collect your order. Mahavir Ganj, Aligarh – 9358251328" })
      ] })
    ] }),
    cart.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 mt-4 text-sm", children: "Your cart is empty" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 mt-4 space-y-3", children: cart.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end justify-between", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-gray-100 rounded-lg px-2 py-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-bold w-4 text-center", children: item.quantity }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-4 bg-white rounded-2xl shadow-sm p-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm text-gray-600 mt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Delivery" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600 font-medium", children: "Pickup only" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t mt-2 pt-2 flex justify-between font-bold", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-20 left-0 right-0 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: "Place Order via WhatsApp"
        }
      ) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, {})
...
function CategoryPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-20 bg-gray-50 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-700 px-4 pt-10 pb-4 flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-white font-bold text-lg", children: [
        category == null ? void 0 : category.emoji,
        " ",
        (category == null ? void 0 : category.name) || "Products"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 mt-4 grid grid-cols-2 gap-3", children: categoryProducts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    ) : categoryProducts.map((p, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        ...
        children: [
              ...
              "img",
              {
                ...
                onError: (e) => {
                  ...
                  if (parent) {
                    ...
                    ph.className = "w-full h-32 bg-gray-100 flex items-center justify-center text-4xl";
                    ph.textContent = (category == null ? void 0 : category.emoji) ?? p.name.charAt(0);
                    parent.insertBefore(ph, e.target);
                  }
                }
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-32 bg-gray-100 flex items-center justify-center text-4xl select-none", children: (category == null ? void 0 : category.emoji) ?? p.name.charAt(0) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: `absolute top-2 right-2 text-white text-xs px-1.5 py-0.5 rounded-full font-medium ${p.isPacked ? "bg-blue-500" : "bg-orange-500"}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-xs text-gray-800 line-clamp-2 leading-tight", children: p.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 text-xs mt-0.5", children: p.size }),
            p.brand && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-600 text-xs mt-0.5", children: p.brand }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-green-700 font-bold text-sm", children: [
                "₹",
                p.price
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
...
🏪 Customer will come to shop to collect`
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-8 bg-gray-50 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-700 px-4 pt-10 pb-4 flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-bold text-lg", children: "Checkout" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-4 bg-amber-50 border border-amber-300 rounded-xl px-4 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-800 font-bold text-sm", children: "🏪 Pickup Only" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-700 text-xs mt-1", children: "Please come to our shop to collect your order." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-800 text-xs font-medium mt-1", children: "Mahavir Ganj, Muchoon Wale Hanuman Ji ke paas, Aligarh – 202001, UP" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-700 text-xs mt-1", children: "📞 9358251328" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-4 bg-white rounded-2xl shadow-sm p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800 text-sm mb-3", children: "Order Summary" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: cart.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t mt-3 pt-3 flex justify-between font-bold", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Total" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-700", children: [
          "₹",
          cartTotal.toFixed(2)
    ...
    user.fullName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-4 mt-4 bg-white rounded-2xl shadow-sm p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-bold text-gray-800 text-sm mb-2", children: "Customer Details" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-700", children: user.fullName }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: user.phone }),
      user.address && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500", children: [
        user.address,
        ", ",
        user.city
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mt-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: loading ? "Placing Order..." : "📱 Send Order via WhatsApp"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-gray-500 mt-2", children: "Order will be sent to 9358251328" })
    ] })
  ] });
}
function OrderSuccess() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-green-600 flex flex-col items-center justify-center px-6 pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "order_success.success_state", className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-full p-6 w-28 h-28 flex items-center justify-center mx-auto mb-6 shadow-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { size: 60, className: "text-green-600" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-3xl font-bold mb-2", children: "Order Placed!" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-100 text-base", children: "Your order is confirmed" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-green-200 text-sm mt-1", children: "We will deliver it to your address soon" })
    ] }),
    lastOrder && lastOrder.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm bg-white/20 backdrop-blur rounded-2xl p-4 mt-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-sm mb-2", children: "Order Summary" }),
      lastOrder.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 bg-white/20 backdrop-blur rounded-2xl p-4 w-full max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs text-center", children: "Order confirmation sent via WhatsApp to our team at 9358251328" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
...
function Orders() {
  ...
  const user = JSON.parse(localStorage.getItem("ncrt_user") || "{}");
  const myOrders = orders.filter((o2) => o2.customerName === user.fullName);
  const statusColor = (s) => ({
  ...
  const buyAgain = (order) => {
    try {
      ...
      ue.error("Could not add items");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-600 px-4 pt-10 pb-4 flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-bold text-lg", children: "My Orders" })
    ] }),
    myOrders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-6xl", children: "📦" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500 mt-4 text-sm", children: "No orders yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 mt-4 space-y-3", children: myOrders.map((order, idx) => {
      const items = (() => {
        try {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1 mb-3", children: [
              items.slice(0, 3).map((i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-600", children: [
                i.name,
                " × ",
                i.quantity
              ] }, i.productId)),
              items.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-400", children: [
                "+",
                items.length - 3,
                " more"
              ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-green-700 font-bold", children: [
                "₹",
                order.totalAmount
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
...
function ProductDetail() {
  ...
  const [selectedWeight, setSelectedWeight] = reactExports.useState("1kg");
  ...
  if (!product)
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-screen", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400", children: "Product not found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
  ...
  const calculatedPrice = product.isPacked ? product.price : Math.round(product.price * WEIGHT_MULTIPLIER[selectedWeight]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-32 bg-gray-50 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      ...
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-64 bg-gray-100 flex items-center justify-center text-6xl select-none", children: ((_a2 = CATEGORIES.find((c) => c.id === product.categoryId)) == null ? void 0 : _a2.emoji) ?? product.name.charAt(0) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { size: 18, className: "text-gray-700" })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-4 bg-white mx-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-bold text-gray-900 mt-0.5", children: product.name }),
          product.brand && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-blue-600 text-sm font-medium", children: product.brand })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `text-white text-xs px-2 py-1 rounded-full font-medium ${product.isPacked ? "bg-blue-500" : "bg-orange-500"}`,
            children: product.isPacked ? "Packed" : "Unpacked"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-600 text-sm mt-2", children: product.description }),
      !product.isPacked && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-700 mb-2", children: "Select Weight:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: UNPACKED_WEIGHTS.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            "data-ocid": "product.toggle",
            onClick: () => setSelectedWeight(w),
            className: `px-3 py-1.5 rounded-lg text-xs font-medium border transition-colors ${selectedWeight === w ? "bg-green-600 text-white border-green-600" : "bg-white text-gray-700 border-gray-300"}`,
            children: w
          },
          w
        )) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-2xl font-bold text-green-700", children: [
          "₹",
          calculatedPrice
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 bg-amber-50 border border-amber-200 rounded-xl px-3 py-2 flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🏪" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-amber-800 text-xs", children: "Pickup from shop — Mahavir Ganj, Aligarh" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-gray-700", children: "Quantity:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 bg-gray-100 rounded-xl px-3 py-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { size: 16, className: "text-gray-700" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-gray-900 w-6 text-center", children: qty }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { size: 16, className: "text-gray-700" })
            }
          )
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed bottom-20 left-0 right-0 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
...
function Settings() {
  ...
  const changeLang = (selectedLang) => {
    ...
    ue.success(`Language changed to ${selectedLang}`);
  };
  const appUrl = window.location.origin;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-20 bg-gray-50 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-green-700 px-4 pt-10 pb-4 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white font-bold text-lg", children: "Settings" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b bg-white", children: ["profile", "language", "barcode"].map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        "data-ocid": "settings.tab",
        onClick: () => setTab(t),
        className: `flex-1 py-3 text-xs font-semibold capitalize transition-colors ${tab === t ? "text-green-600 border-b-2 border-green-600" : "text-gray-500"}`,
        children: t === "profile" ? "👤 Profile" : t === "language" ? "🌐 Language" : "📱 Barcode"
      },
      t
    )) }),
    tab === "profile" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mt-4 space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "label",
          {
    ...
    tab === "language" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-sm p-4 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-gray-800 mb-3", children: "Quick Language Switch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-3", children: ["English", "Hindi"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            "data-ocid": "settings.toggle",
            onClick: () => changeLang(l),
            className: `flex-1 py-3 rounded-xl text-sm font-semibold transition-colors ${lang === l ? "bg-green-600 text-white" : "bg-gray-100 text-gray-700"}`,
            children: l === "English" ? "🇬🇧 English" : "🇮🇳 Hindi"
          },
          l
        )) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-sm p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-gray-800 mb-3", children: "All Languages" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: LANGUAGES.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            type: "button",
            "data-ocid": "settings.tab",
            onClick: () => changeLang(l),
            className: `w-full flex items-center justify-between px-4 py-3 rounded-xl text-sm transition-colors ${lang === l ? "bg-green-50 text-green-700 font-semibold" : "text-gray-700 hover:bg-gray-50"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: l }),
              lang === l && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600", children: "✓" })
            ]
          },
          l
        )) })
    ...
    tab === "barcode" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 mt-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-sm p-6 flex flex-col items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-gray-800 mb-4", children: "Share App" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-4 text-center", children: "Scan to open NEW C.R. TRADERS app" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-1 text-center break-all", children: appUrl })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-2xl shadow-sm p-4 mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-gray-700 mb-1", children: "Shop Details" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600", children: "NEW C.R. TRADERS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Mahavir Ganj, Muchoon Wale Hanuman Ji ke paas" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Aligarh – 202001, UP" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mt-1", children: "📞 9358251328" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-1", children: "GSTIN: 09BTFPK1482H1ZK" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400", children: "FSSAI: 22727411000024" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(BottomNav, {})
  ] });
...
function SignIn() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-green-50 to-white flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col items-center justify-center px-6 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-green-800", children: "NEW C.R. TRADERS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "New Chitarmal Ram Prasad Traders" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-1", children: "Mahavir Ganj, Aligarh" })
    ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-sm text-gray-500 mt-6", children: [
      "New customer?",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-xs text-gray-400 mt-3", children: [
      "Admin?",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/admin-login", className: "text-gray-500 underline", children: "Admin Login" })
    ] })
  ] }) }) });
}
...
function SignUp() {
  ...
  const [termsRead, setTermsRead] = reactExports.useState(false);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!termsAccepted) {
      ue.error("Please accept terms and conditions");
      return;
    }
    ...
    if (form.phone.length < 10) {
      ue.error("Enter a valid phone number");
      return;
    }
    setLoading(true);
    const users = JSON.parse(localStorage.getItem("ncrt_users") || "[]");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gradient-to-br from-green-50 to-white flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col items-center justify-start px-6 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-bold text-green-800", children: "NEW C.R. TRADERS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500", children: "Create your account" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-gray-700 mb-1", children: "Terms & Conditions *" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 mt-2 cursor-pointer", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-600", children: "I have read and agree to the Terms & Conditions" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
...
function PrivateRoute({ children }) {
  ...
  return isLoggedIn ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Navigate, { to: "/signin", replace: true });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BrowserRouter, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center bg-gray-100 min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-md bg-white min-h-screen relative", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/signin", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SignIn, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/signup", element: /* @__PURE__ */ jsxRuntimeExports.jsx(SignUp, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/home",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(PrivateRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Home, {}) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/category/:id",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(PrivateRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryPage, {}) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/product/:id",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(PrivateRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductDetail, {}) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/cart",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(PrivateRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cart, {}) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/checkout",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(PrivateRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Checkout, {}) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/order-success",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(PrivateRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(OrderSuccess, {}) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/orders",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(PrivateRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Orders, {}) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Route,
        {
          path: "/settings",
          element: /* @__PURE__ */ jsxRuntimeExports.jsx(PrivateRoute, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, {}) })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/admin", element: /* @__PURE__ */ jsxRuntimeExports.jsx(AdminLogin, {}) }),
...
Service({
  ...
  "addLoyaltyPoints": Func([Principal2, Nat], [], []),
  "assignCallerUserRole": Func([Principal2, UserRole], [], []),
  "createCategory": Func([Category], [], []),
  "createOrder": Func([Order], [], []),
  "createProduct": Func([Product], [], []),
  "deleteCategory": Func([Text], [], []),
  "deleteOrder": Func([Text], [], []),
  "deleteProduct": Func([Text], [], []),
  "getAllCategories": Func([], [Vec(Category)], ["query"]),
  ...
  "getCategory": Func([Text], [Category], ["query"]),
  "getLoyaltyPoints": Func([Principal2], [Nat], ["query"]),
  "getOrder": Func([Text], [Order], ["query"]),
  "getProduct": Func([Text], [Product], ["query"]),
  "getUserProfile": Func(
    [Principal2],
    [Opt(UserProfile)],
    ["query"]
  ),
  "initializeSeedData": Func([], [], []),
  "isAdmin": Func([Text, Text], [Bool], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "saveCallerUserProfile": Func([UserProfile], [], []),
  "updateCategory": Func([Category], [], []),
  "updateOrder": Func([Order], [], []),
